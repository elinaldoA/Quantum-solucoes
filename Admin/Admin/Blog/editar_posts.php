        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../Blog/editar_posts.php" class="nav-link">
        ...
        <div class="row">
          <div class="col-md-12 col">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="../processa/proc_edit_post.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="imagem">Enviar imagem</label>
                    <div class="input-group">
                      <input type="file" class="form-control col-sm-6" name="imagem" id="imagem" 
                      value="<?php echo $resultado['imagem']; ?>">

                    </div>
                    <div class="form-group">
                    <label for="autor">Autor</label>
                    <input type="text" class="form-control" name="autor" id="autor" placeholder="Autor do post" value="<?php echo $resultado['autor'];?>">
                  </div>
                  <div class="form-group">
                  <label for="categoria" class="col-sm-2 control-label">Categorias</label>
                  <div class="form-group">
                  <select class="form-control col-sm-4" name="categoria">
                  <option><?php echo $resultado["categoria"]?></option>
                  <option value="Investimentos"><?php
                    if ( $resultado ['categoria'] == 1) {
                      echo 'selected';
                    }
                  ?>Investimentos</option>
                  <option value="Orçamentos"><?php
                    if ( $resultado ['categoria'] == 2) {
                      echo 'selected';
                    }
                  ?>Orçamentos</option>
                  <option value="Contabilidade"><?php
                    if ( $resultado ['categoria'] == 3) {
                      echo 'selected';
                    }
                  ?>Contabilidade</option>
                  <option value="Irpf"><?php
                    if ( $resultado ['categoria'] == 4) {
                      echo 'selected';
                    }
                  ?>Irpf</option>
                  <option value="Legislação"><?php
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" placeholder="titulo" value="<?php echo $resultado['titulo']; ?>">
                  </div>
                  <div class="form-group">
