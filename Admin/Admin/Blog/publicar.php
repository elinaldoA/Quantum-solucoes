        ...
        <div class="row">
          <div class="col-md-12 col">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="../processa/proc_adc_post.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <textarea name="conteudo" id="conteudo" class="form-control" placeholder="conteúdo completo do post" rows="8"></textarea>
                  </div>
                </div>
