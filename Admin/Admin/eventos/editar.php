...
//execulta consulta
$result = mysqli_query($conectar,"SELECT * FROM eventos where id = '$id' LIMIT 1");
        ...
        <div class="row">
          <div class="col-md-12 col">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="../processa/proc_edit_eventos.php" enctype="multipart/form-data">
                <div class="card-body">
