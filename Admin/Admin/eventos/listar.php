              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    ?>
                  <td>
                  <a href='editar.php?link=4&id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-warning btn-flat'>Viualizar</button> </a>
                  <a href='../processa/proc_del_eventos.php?&id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-danger btn-flat'>Deletar</button> </a>
                  <?php
                  echo "</tr>";
                  }
                  ?>
