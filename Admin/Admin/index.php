...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/favicon.png" alt="" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../Admin/usuarios/Listar_usuarios.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../Admin/eventos/cadastrar.php" class="nav-link">
                  <i class="fa fa-newspaper-o nav-icon"></i>
                  <p>Novo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../Admin/eventos/listar.php" class="nav-link">
                  <i class="fa fa-check-circle nav-icon"></i>
                  <p>Listar</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../Admin/Blog/publicar.php" class="nav-link">
                  <i class="fa fa-list-alt nav-icon"></i>
                  <p>Publicar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../Admin/Blog/listar_post.php" class="nav-link">
                  <i class="fa fa-check-circle nav-icon"></i>
                  <p>Listar</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item has-treeview">
              <a href="../Admin/sair.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Seja bem vindo Administrador</h1>
            <br />
            <br />
            <br />
            <br />
