...
$sql = mysqli_query($conectar,"INSERT INTO eventos(autor, data, titulo, imagem, conteudo_completo)
VALUES ('$autor', NOW(), '$titulo', '$nome_imagem','$conteudo')") or die("Erro ao tentar cadastrar registro" .mysqli_error($conectar));
