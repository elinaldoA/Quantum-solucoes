...
<body class="hold-transition sidebar-mini">
  <?php
      $resultado=mysqli_query($conectar,"SELECT * FROM registrar_usuarios ORDER BY 'id'");
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    ?>
                  <td>
                  <a href='editar_usuarios.php?link=4&id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-warning btn-flat'>Editar</button> </a>
                  <a href='../processa/proc_del_usuario.php?&id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-danger btn-flat'>Deletar</button> </a>
                  <?php
                  echo "</tr>";
                  }
                  ?>
