	...
	<!-- blog-details-area start -->
        <section class="blog-details-area ptb-140">
            <div class="container">
                ...
                <p>Fique sempre bem informado sobre os assuntos relacionados ao mundo contábil.

                <p>Conhecimento vale muito.</p>

                <p>Estar bem informado é imprescindível para ter controle sobre o seu negócio. Acompanhe nosso canal de informação e esteja sempre por dentro do que é relevante para sua empresa.
                </p>
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <?php
                        include("Admin/Blog/mostrar_post.php");
                        ?>
                    </div>
                    <br>
                    <br>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 col">
                        <aside class="right-sidebar">
                            <div class="search-sidebar mb-30">
                                <form  method="post" action="Admin/buscar.php" enctype="multipart/form-data">
