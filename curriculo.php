...
<html class="no-js" lang="pt-br">
    <head>
        ...
        <title>Quantum || Currículos</title>
   ...
   <body>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="contact-info text-left">
                                    <span>Segunda - Quinta (08hs às 18hs)</span>
                                    <span>Sexta (08hs às 17hs)</span>
        ...
        <div class="mainmenu">
               <ul id="navigation">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="pessoa-fisica.html">Pessoa física</a></li>
                    <li><a href="fiscal.html">Fiscal</a></li>
                    <li><a href="contabil.html">Contábil</a></li>
                    <li><a href="pessoal.html">Pessoal</a></li>
                </ul>
                </li>
                <li><a href="blog.php">Informes</a></li>
                <li><a href="contato.php">Fale conosco</a></li>
                <li><a href="#">Trabalhe conosco</a></li>
                <li><a href="#">Parceiros</a></li>
                <li class="active"><a href="https://areadocliente.sci10.com.br/loginForm.php">Área do cliente</a></li>
            </ul>
        </div>
    </div>
    ...
    <!-- Inicio do formulário de curriculos-->
    <br>
    <br>
    <section>
      <div class="container">
    	<div class="row">
			<div class="col-xs-12">
				<div class="section-title text-center">
					<h2>Banco de talentos Quantum</h2>
				</div>
			</div>
		</div>
  	   <form class="form-horizontal form-responsive" method="post" action="dados.php">
         ...
         <div class="form-group">
          <label for="curriculo" class="col-sm-2 control-label">Anexar</label>
          <div class="col-sm-4">
            <input type="file" class="form-control" id="arquivo" name="arquivo" required="" autofocus="" />
            <br>
            <button id="submit" class="btn-style" name="submit">Enviar</button>
            </div>
          </div>
       </form>
    <br>
    ...
    <!-- Fim do formulário do canditado -->
    <!-- Inicio do chatbot -->
